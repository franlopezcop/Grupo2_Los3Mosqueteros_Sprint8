...
const productController = {
    ...
    listadoProductos: async (req,res) =>{
        try {
            ...
            let countByCategory = {}
            countByCategory.table = table.length
            countByCategory.coffeeTable = coffeeTable.length
            countByCategory.mirror = mirror.length
            countByCategory.desk = desk.length
            let products = []
            ...
            let respuesta = {count, countByCategory, products}
